...
#######################################################
# Unused/old trial code below
#######################################################

## These methods will return GraphNodes
#DEFERRED_METH = ("len,getitem,setitem,reversed,contains,"
...
#        "int,long,float,oct,hex,index,"
#        #"coerce,"
#        "lt,le,eq,ne,gt,ge,cmp,nonzero").split(",")
## These methods will trigger an eval()
#EVAL_METH = ("iter",)

#class Graphable(type):

#    def __new__(cls, name, bases, dct):
#        #import pdb; pdb.set_trace()
#        for name in DEFERRED_METH:
#            methname = "__" + name + "__"
#            if methname in dct:
#                if DEBUG:
#                    print "Overriding", methname
#                meth = dct[methname]
#                dct[methname] = lambda *args, **kw: GraphNode(methname, meth, args, kw)
...
#            meth = cls.__dict__[methname]
#            cls.__dict__[methname] = lambda *args, **kw: GraphNode(methname, meth, args, kw)
#            # TODO: What to do with EVAL_METHs?
#    return cls
